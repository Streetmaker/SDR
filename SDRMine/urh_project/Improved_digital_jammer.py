...
class Improved_digital_jammer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Improved_digital_jammer")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Improved_digital_jammer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Improved_digital_jammer")
        ...
        self.myconstell = myconstell = digital.constellation_calcdist([-1-1j, -1+1j, 1+1j, 1-1j], [0, 1, 3, 2],
        4, 1).base()
        self.center_freq_slider = center_freq_slider = 95.1

        ##################################################
        # Blocks
        ##################################################
        self._center_freq_slider_range = Range(0, 100, 1, 95.1, 200)
...
def main(top_block_cls=Improved_digital_jammer, options=None):
