...
class Transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_freq_slider = center_freq_slider = 96.5e6

        ##################################################
        # Blocks
        ##################################################
        self._center_freq_slider_range = Range(88e6, 108e6, 10e3, 96.5e6, 200)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/andre.l.berry22/Desktop/SDRMine/urh_project/mixkit-dog-barking-twice-1.wav', True)
