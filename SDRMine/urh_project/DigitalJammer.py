...
class DigitalJammer(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "DigitalJammer")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("DigitalJammer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "DigitalJammer")
        ...
        self.myconstell = myconstell = digital.constellation_bpsk().base()
        self.center_freq_slider = center_freq_slider = 98.5e6

        ##################################################
        # Blocks
        ##################################################
        self._center_freq_slider_range = Range(88e6, 108e6, 10e3, 98.5e6, 200)
        ...
        self.osmosdr_sink_0.set_time_source('external', 0)
    ...
    def get_myconstell(self):
        return self.myconstell

    def set_myconstell(self, myconstell):
        self.myconstell = myconstell
...
def main(top_block_cls=DigitalJammer, options=None):
